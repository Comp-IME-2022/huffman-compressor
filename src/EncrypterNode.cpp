...
EncrypterNode* EncrypterNode::getLeft() { return this->left; }

void EncrypterNode::setLeft(EncrypterNode* left) { this->left = left; }

EncrypterNode* EncrypterNode::getRight() { return this->right; }

void EncrypterNode::setRight(EncrypterNode* right) { this->right = right; }